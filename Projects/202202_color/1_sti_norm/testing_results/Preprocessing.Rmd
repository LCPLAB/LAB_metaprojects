...
## export system data
write_csv(select(df, system_cols),file="color_pilot_system.csv")

## export study data
write_csv(select(df, -system_cols,"jatosStudyResultId"),file = "color_pilot_data.csv")
...
write.csv(finished_id, file="color_Pilot_id.txt")
```
