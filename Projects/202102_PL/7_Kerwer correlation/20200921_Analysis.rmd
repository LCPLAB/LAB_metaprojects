...
H2_H4_cor <- cor.test(H1$M_Comprehensibility,H1$M_ability_to_evaluate, use = "complete.obs", method = "pearson") %>% 
  broom::tidy()

H2_H5_cor <- cor.test(H1$M_Comprehensibility,H1$M_ability_to_make_a_decision, use = "complete.obs", method = "pearson") %>% 
  broom::tidy()
...
H2_H4_cor <- cor.test(H2$M_accquision,H2$M_ability_to_evaluate, use = "complete.obs", method = "pearson") %>% 
  broom::tidy()

H2_H5_cor <- cor.test(H2$M_accquision,H2$M_ability_to_make_a_decision, use = "complete.obs", method = "pearson") %>% 
  broom::tidy()
