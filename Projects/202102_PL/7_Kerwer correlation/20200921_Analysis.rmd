...
H1_H3_cor <- cor.test(df$vst,df$vtr, use = "complete.obs", method = "spearman") %>% 
  broom::tidy()

H1_H4_cor <- cor.test(df$vst,df$wahr, use = "complete.obs", method = "spearman") %>% 
  broom::tidy()

H1_H5_cor <- cor.test(df$vst,df$ent, use = "complete.obs", method = "spearman") %>% 
  broom::tidy()
...
H2_H3_cor <- cor(H2$score1,H3$score2, use = "complete.obs", method = "pearson")
