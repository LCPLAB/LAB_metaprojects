...
m4a <- lmer(response ~(1 | Text_id) + NH+ OSA + ability + familiarity +  (OSA | jatosStudyResultId), data = subset(df_Post_ext, Topic == "Comprehensibility"))
m4b <- lmer(response ~(1 | Text_id) + NH+ OSA * ability +  OSA * familiarity + (OSA | jatosStudyResultId), data = subset(df_Post_ext, Topic == "Comprehensibility"))


anova(m3a,m4a) ## fittest is m3a
anova(m3a,m4b) ## fittest is m3a
...
## 決定未加入個別差異因素的最佳模型
#df_knowledge$NH <- df_knowledge$PLS == "No Heading"
#df_knowledge$OSA <- df_knowledge$PLS == "Non PLS"

#Random Intercept

m00 <- glmer(score ~ NH + OSA +(1 | Test_id/Set_id), data = df_knowledge, family = binomial("logit"))
m1 <- glmer(score ~ NH + OSA + (1 | Test_id/Set_id) + (1 | jatosStudyResultId), data = df_knowledge, family = binomial("logit"))

anova(m00, m1)

m1 <- glmer(score ~ (1 | Test_id/Set_id) + NH + OSA  + (1 | jatosStudyResultId), data = df_knowledge, family = binomial("logit"))

#non-convergence
m2a <- glmer(score ~ (1 | Test_id/Set_id) + NH + OSA + (OSA | jatosStudyResultId), data = df_knowledge, family = binomial("logit"))
summary(m2a)

m2b <- glmer(score ~ (1 | Test_id/Set_id) + NH + OSA + (NH | jatosStudyResultId), data = df_knowledge, family = binomial("logit"))
summary(m2b)

anova(m1, m2b)

m3 <- glmer(response ~ (1 | Test_id/Set_id) + NH + OSA + PJ + JA + MS  + (1 | jatosStudyResultId), data = subset(df_Post_ext, Q_type == "Knowledge"), family = binomial("logit"))
...
m3a <- lmer(response ~(1 | Test_id) + NH+ OSA + JA + PJ + MS +   (OSA | jatosStudyResultId), data = subset(df_Post_ext, Q_type == "Knowledge"))
m3b <- lmer(response ~(1 | Test_id) + NH+ OSA * JA   + OSA * PJ + OSA * MS +   (OSA | jatosStudyResultId), data = df_knowledge)
...
## 評估科學活動經驗
m4a <- lmer(response ~(1 | Test_id) + NH+ OSA + ability + familiarity +  (OSA | jatosStudyResultId), data = subset(df_Post_ext, Q_type == "Knowledge"))
m4b <- lmer(response ~(1 | Test_id) + NH+ OSA * ability +  OSA * familiarity + (OSA | jatosStudyResultId), data = subset(df_Post_ext, Q_type == "Knowledge"))
...
m3a <- lmer(response ~(1 | Text_id) + NH+ OSA + JA + PJ + MS +   (OSA | jatosStudyResultId), data = subset(df_Post_ext, Topic == "Veracity"))
m3b <- lmer(response ~(1 | Text_id) + NH+ OSA * JA   + OSA * PJ + OSA * MS +   (OSA | jatosStudyResultId), data = subset(df_Post_ext, Topic == "Veracity"))
...
m4a <- lmer(response ~(1 | Text_id) + NH+ OSA + ability + familiarity +  (OSA | jatosStudyResultId), data = subset(df_Post_ext, Topic == "Veracity"))
m4b <- lmer(response ~(1 | Text_id) + NH+ OSA * ability +  OSA * familiarity + (OSA | jatosStudyResultId), data = subset(df_Post_ext, Topic == "Veracity"))


anova(m3b,m4a) ## fittest is m3b
anova(m3b,m4b) ## fittest is m3b
...
#anova(m,m3a)
#summary(m3a)
m3a <- lmer(response ~(1 | Text_id) + NH+ OSA + JA + PJ + MS +   (OSA | jatosStudyResultId), data = subset(df_Post_ext, Topic == "Decision"))
m3b <- lmer(response ~(1 | Text_id) + NH+ OSA * JA   + OSA * PJ + OSA * MS +   (OSA | jatosStudyResultId), data = subset(df_Post_ext, Topic == "Decision"))
...
## 評估科學活動經驗
m4a <- lmer(response ~(1 | Text_id)  + NH+ OSA + ability + familiarity + (OSA | jatosStudyResultId), data = subset(df_Post_ext, Topic == "Decision"))

m4b <- lmer(response ~(1 | Text_id)  + NH+ OSA + OSA*ability + OSA*familiarity + (OSA | jatosStudyResultId), data = subset(df_Post_ext, Topic == "Decision"))
