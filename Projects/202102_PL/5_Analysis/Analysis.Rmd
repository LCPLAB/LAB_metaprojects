...
cre_m0 <- lmer(response ~ (1 | jatosStudyResultId), data = subset(df_Post, Topic == "Credibility"))
cre_m00 <- lmer(response ~ (1 | Test_id), data = subset(df_Post, Topic == "Credibility"))

summary(cre_m0)
performance::icc(cre_m0)

summary(cre_m00)
performance::icc(cre_m00)

## 確認最適模型

cre_m1 <- lmer(response ~ (1 | jatosStudyResultId) + article_type + (1 | Text_id), data = subset(df_Post, Topic == "Credibility"))

anova(cre_m0, cre_m1)  ## fittest is m1
...
test = glht(cre_m1,linfct=mcp(article_type="Tukey"))
summary(test, test = adjusted("none"))
