...
text <- readr::read_csv("../4_OS_Result/text_id.csv")

## Extract the system variables
df_sys <- select(df, starts_with(c("identifier","jatos","browser_","count_","date_","experiment_","screen_","system_","Start ","Last ","Duration","Batch","Worker ","State","Message")))

## Reserve the analytical variables in rawdata df
df <- select(df, !names(df_sys)[-c(1,2)])
