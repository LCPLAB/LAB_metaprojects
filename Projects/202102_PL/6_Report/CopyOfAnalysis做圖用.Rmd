...
Correct_rate <- df_post_trend %>% 
  summarise(CR = mean(Correct_rate)) %>%
  print()
...
H1_participant_icc <- (performance::icc(m0) %>% unlist())[1]
...
H1_study_icc <- (performance::icc(m00) %>% unlist())[1]
...
H3_participant_icc <- (performance::icc(m0) %>% unlist())[1]

summary(m00)
performance::icc(m00)

H3_study_icc <- (performance::icc(m00) %>% unlist())[1]

## 確認最適模型

m1 <- lmer(response ~ (1 | jatosStudyResultId) + article_type + (1 | Text_id), data = subset(df_Post, Topic == "Credibility"))
...
H4_participant_icc <- (performance::icc(m0) %>% unlist())[1]
...
H4_study_icc <- (performance::icc(m00) %>% unlist())[1]

## 確認最適模型


m1 <- lmer(response ~ (1 | jatosStudyResultId) + article_type + (1 | Text_id), data = subset(df_Post, Topic == "Veracity"))
...
H5_participant_icc <- (performance::icc(m0) %>% unlist())[1]


summary(m00)
performance::icc(m00)

H5_study_icc <- (performance::icc(m00) %>% unlist())[1]

## 確認最適模型


m1 <- lmer(response ~ (1 | jatosStudyResultId) + article_type + (1 | Text_id), data = subset(df_Post, Topic == "Decision"))
...
m0 <- lmer(response ~ (1 | jatosStudyResultId), data = subset(df_Post, Topic == "Scientificness"))
m00 <- lmer(response ~ (1 | Test_id), data = subset(df_Post, Topic == "Scientificness"))

summary(m0)
performance::icc(m0)

Scientificness_participant_icc <- (performance::icc(m0) %>% unlist())[1]


summary(m00)
performance::icc(m00)

Scientificness_study_icc <- (performance::icc(m00) %>% unlist())[1] ## retrieve study icc


## 確認最適模型


m1 <- lmer(response ~ (1 | jatosStudyResultId) + article_type + (1 | Text_id), data = subset(df_Post, Topic == "Scientificness"))
...
Access_participant_icc <- (performance::icc(m0) %>% unlist())[1]
...
m00 <- lmer(response ~ (1 | Test_id), data = subset(df_Post, Topic == "Access"))

Access_study_icc <- (performance::icc(m00) %>% unlist())[1]
...
H1_1 <- (anova(m00, m1) %>% # Random Intercept Participant 
...
H1_2 <- (anova(m2a, m1) %>% 	# Random Slope OSA by Participant 
dplyr::select("Chisq":"Pr(>Chisq)"))[-1,]

H1_3 <- (anova(m2b, m1)%>% 	# Random Slope No Subheadings by Participant 
dplyr::select("Chisq":"Pr(>Chisq)"))[-1,] 
...
H1_4 <- (anova(m1,m3a) %>% # Justification Beliefs on Random Intercept 	
dplyr::select("Chisq":"Pr(>Chisq)"))[-1,]

H1_5 <- (anova(m3a,m3b) %>% # Justification Beliefs on Random Slope OSA 	
dplyr::select("Chisq":"Pr(>Chisq)"))[-1,]
...
H1_6 <- (anova(m1,m4a) %>% # 科學活動 on Random Intercept 	
dplyr::select("Chisq":"Pr(>Chisq)"))[-1,]

H1_7 <- (anova(m4a,m4b) %>% # 科學活動 on Random Slope OSA 	
dplyr::select("Chisq":"Pr(>Chisq)"))[-1,]

Likelihood_Ratio_Test = c("Random Intercept Participant","Random Slope OSA by Participant","Random Slope No Subheadings by Participant","Justification Beliefs on Random Intercept","Justification Beliefs on Random Slope OSA","科學活動 on Random Intercept","科學活動 on Random Slope OSA")

H1_ratio_tests <- (bind_rows(H1_1,H1_2,H1_3,H1_4,H1_5,H1_6,H1_7) %>%
  mutate(Likelihood_Ratio_Test))[,c(4,1,2,3)]
...
H2_1 <- (anova(m0a, m0b) %>%  #Random Intercept Participant 	
dplyr::select("Chisq":"Pr(>Chisq)"))[-1,]
...
H2_2 <- (anova(m0a, m1a) %>%  #Random Slope OSA by Participant  	
dplyr::select("Chisq":"Pr(>Chisq)"))[-1,]

H2_3 <- (anova(m0b, m1b)%>% 	# Random Slope No Subheadings by Participant 
dplyr::select("Chisq":"Pr(>Chisq)"))[-1,] 
...
#H2_4 <- (anova(m2, m2a) %>% # Justification Beliefs on Random Intercept 	
#dplyr::select("Chisq":"Pr(>Chisq)"))[-1,]

#H2_5 <- (anova(m2,m2b) %>% # Justification Beliefs on Random Slope OSA 	
#dplyr::select("Chisq":"Pr(>Chisq)"))[-1,]
...
H2_6 <- (anova(m0a,m3) %>% # 科學活動 on Random Intercept 	
dplyr::select("Chisq":"Pr(>Chisq)"))[-1,]

#H2_7 <- (anova(m4a,m4b) %>% # 科學活動 on Random Slope OSA 	
#dplyr::select("Chisq":"Pr(>Chisq)"))[-1,]

anova(m0a, m3) # fittest is m0

#H2_ratio_tests <- bind_rows(H2_1,H2_2,H2_3,H2_4,H2_5,H2_6)%>%
#  mutate(Likelihood_Ratio_Test)
...
H3_1 <- (anova(m00, m1) %>% # Random Intercept Participant 
dplyr::select("Chisq":"Pr(>Chisq)"))[-1,]
...
H3_2 <- (anova(m2a, m1) %>% 	# Random Slope OSA by Participant 
dplyr::select("Chisq":"Pr(>Chisq)"))[-1,]

H3_3 <- (anova(m2b, m1)%>% 	# Random Slope No Subheadings by Participant 
dplyr::select("Chisq":"Pr(>Chisq)"))[-1,] 
...
H3_4 <- (anova(m2a,m3a) %>% # Justification Beliefs on Random Intercept 	
dplyr::select("Chisq":"Pr(>Chisq)"))[-1,]

H3_5 <- (anova(m2a,m3b) %>% # Justification Beliefs on Random Slope OSA 	
dplyr::select("Chisq":"Pr(>Chisq)"))[-1,]
...
H3_6 <- (anova(m2a,m4a) %>% # 科學活動 on Random Intercept 	
dplyr::select("Chisq":"Pr(>Chisq)"))[-1,]

H3_7 <- (anova(m2a,m4b) %>% # 科學活動 on Random Slope OSA 	
dplyr::select("Chisq":"Pr(>Chisq)"))[-1,]

H3_ratio_tests <- bind_rows(H3_1,H3_2,H3_3,H3_4,H3_5,H3_6,H3_7) %>%
  mutate(Likelihood_Ratio_Test)
...
H4_1 <- (anova(m00, m1) %>% # Random Intercept Participant 
dplyr::select("Chisq":"Pr(>Chisq)"))[-1,]
...
H4_2 <- (anova(m2a, m1) %>% 	# Random Slope OSA by Participant 
dplyr::select("Chisq":"Pr(>Chisq)"))[-1,]

H4_3 <- (anova(m2b, m1)%>% 	# Random Slope No Subheadings by Participant 
dplyr::select("Chisq":"Pr(>Chisq)"))[-1,] 
...
H4_4 <- (anova(m1,m3a) %>% # Justification Beliefs on Random Intercept 	
dplyr::select("Chisq":"Pr(>Chisq)"))[-1,]

H4_5 <- (anova(m1,m3b) %>% # Justification Beliefs on Random Slope OSA 	
dplyr::select("Chisq":"Pr(>Chisq)"))[-1,]
...
H4_6 <- (anova(m1,m4a) %>% # 科學活動 on Random Intercept 	
dplyr::select("Chisq":"Pr(>Chisq)"))[-1,]

H4_7 <- (anova(m1,m4b) %>% # 科學活動 on Random Slope OSA 	
dplyr::select("Chisq":"Pr(>Chisq)"))[-1,]

H4_ratio_tests <- bind_rows(H4_1,H4_2,H4_3,H4_4,H4_5,H4_6,H4_7) %>%
  mutate(Likelihood_Ratio_Test)
...
H5_1 <- (anova(m00, m1) %>% # Random Intercept Participant 
dplyr::select("Chisq":"Pr(>Chisq)"))[-1,]
...
H5_2 <- (anova(m2a, m1) %>% 	# Random Slope OSA by Participant 
dplyr::select("Chisq":"Pr(>Chisq)"))[-1,]

H5_3 <- (anova(m2b, m1)%>% 	# Random Slope No Subheadings by Participant 
dplyr::select("Chisq":"Pr(>Chisq)"))[-1,] 
...
H5_4 <- (anova(m1,m3a) %>% # Justification Beliefs on Random Intercept 	
dplyr::select("Chisq":"Pr(>Chisq)"))[-1,]

H5_5 <- (anova(m1,m3b) %>% # Justification Beliefs on Random Slope OSA 	
dplyr::select("Chisq":"Pr(>Chisq)"))[-1,]
...
H5_6 <- (anova(m1,m4a) %>% # 科學活動 on Random Intercept 	
dplyr::select("Chisq":"Pr(>Chisq)"))[-1,]

H5_7 <- (anova(m1,m4b) %>% # 科學活動 on Random Slope OSA 	
dplyr::select("Chisq":"Pr(>Chisq)"))[-1,]


H5_ratio_tests <- bind_rows(H5_1,H5_2,H5_3,H5_4,H5_5,H5_6,H5_7) %>%
  mutate(Likelihood_Ratio_Test)
...
table <- (tb_Post %>%
  pivot_wider(names_from = article_type, values_from = c(M,SD)))[,c(1,2,4,7,5,8,3,6)]


Topic = c("Comprehensibility","Credibility","Veracity","Decision","Scientificness","Access")

ICC_Participants = c(H1_participant_icc,H3_participant_icc,H4_participant_icc,H5_participant_icc,Scientificness_participant_icc,Access_participant_icc)

ICC_Study = c(H1_study_icc,H3_study_icc,H4_study_icc,H5_study_icc,Scientificness_study_icc,Access_study_icc)

ICC_table <- tibble(
  Topic = Topic,
  ICC_Participants = ICC_Participants,
  ICC_Study = ICC_Study)

table3 <- left_join(ICC_table, table, by = "Topic") 


table6 <- left_join(H1_ratio_tests, H3_ratio_tests, by = "Likelihood_Ratio_Test") %>%
  left_join(H4_ratio_tests, by = "Likelihood_Ratio_Test") %>%
  left_join(H5_ratio_tests, by = "Likelihood_Ratio_Test")
