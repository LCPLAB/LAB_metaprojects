...
test_m0a <- anova(m0a, m0b) %>% broom::tidy() %>%
  filter(term == "m0a")

test_m0a <- test_m0a[c("statistic","df","p.value")] %>% as.data.frame() %>% round(3)
...
test_m1a <- test_m1a[c("statistic","df","p.value")] %>% as.data.frame() %>% round(3)

test_m1b <- anova(m0a, m1b) %>% broom::tidy() %>%
  filter(term == "m1b")

test_m1b <- test_m1b[c("statistic","df","p.value")] %>% as.data.frame() %>% round(3)
...
test_m3 <- test_m3[c("statistic","df","p.value")] %>% as.data.frame() %>% round(3)
