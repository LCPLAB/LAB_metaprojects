...
downloaded_rawdata <- "psytoolkit_data.zip"
...
starting_dt <- as.POSIXlt("2021-11-17-00:00:00 UTC",tz="UTC")
## Import data
...
pandemic_conf <- survey_data %>% select(participant,starts_with("1_xinxi_Q1")) %>%
## Transfer the raw data to long data table
  pivot_longer(!participant, names_to = "item",values_to = "response") %>% 
